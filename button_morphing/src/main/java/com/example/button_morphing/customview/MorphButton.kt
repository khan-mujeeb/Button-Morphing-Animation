package com.example.button_morphing.customview
...
import com.example.button_morphing.*
...
class MorphButton @JvmOverloads constructor(
    ...
    var fromBgColor: Int = getColorX(R.color.light_green)
    ...
    var iconDrawable = getDrawableX(R.drawable.round_loading)
        set(value) {
            field = value
            setSizeIcon()
        }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        getTextPaint().let { paint ->
            ...
            val widthBtn = widthMeasureSpec + paddingStart + paddingEnd
            val heightBtn = heightMeasureSpec + paddingTop + paddingBottom
